export AbstractModel, AbstractPolarizedModel
export IsPrimitive, NotPrimitive
export IsAnalytic, NotAnalytic
export visanalytic, imanalytic
export visibility_point, intensity_point
export intensitymap!, intensitymap
export radialextent, flux
...
The abstract model type. To instantiate your own model type you should
